...
import { CurrencyDollarIcon, DocumentTextIcon, UserCircleIcon } from "@heroicons/react/24/outline";
import Link from "next/link";
import { Button } from "../button";
import { OfficeState, updateOffice } from "@/app/lib/actions";
...
export default function EditBranchForm({
  ...
  const handleFormSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // state.message
    useEffect(() => {
      if (state.message === "Office edited successfully.") {
